...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" runat="server">
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <p><a class="btn btn-primary btn-lg" role="button" href="https://github.com/gapessoa/LocadoraCarrosSite/">Veja o código-fonte no GIT</a></p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p><a class="btn btn-warning" href="~/CadastrarLocatario.aspx" role="button" runat="server">Acessar &raquo;</a></p>
            </div>
            <div class="col-md-4">
                <h2>Cadastro de Condutores</h2>
                <p>Faça o cadastro do condutor, bem como os dados de sua CNH.</p>
                <p><a class="btn btn-info" href="~/CadastrarCondutor.aspx" role="button" runat="server">Acessar &raquo;</a></p>
            </div>
            <div class="col-md-4">
                <h2>Cadastro de Locações</h2>
                <p>Registre uma locação, depois registre sua devolução. O custo final será gerado aqui.</p>
                <p><a class="btn btn-success" href="~/CadastrarLocacao.aspx" role="button" runat="server">Acessar &raquo;</a></p>
            </div>
        </div>
</asp:Content>
