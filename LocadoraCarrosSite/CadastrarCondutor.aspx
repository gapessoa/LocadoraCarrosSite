            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <asp:TextBox ID="txtNome" runat="server" CssClass="form-control" MaxLength="255"></asp:TextBox>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" TextMode="Email" MaxLength="255"></asp:TextBox>
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <asp:TextBox ID="txtLogradouro" runat="server" CssClass="form-control" MaxLength="255"></asp:TextBox>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <asp:TextBox ID="txtComplemento" runat="server" CssClass="form-control" MaxLength="255"></asp:TextBox>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <asp:TextBox ID="txtBairro" runat="server" CssClass="form-control" MaxLength="255"></asp:TextBox>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <asp:TextBox ID="txtCEP" runat="server" CssClass="form-control" MaxLength="9"></asp:TextBox>
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <asp:TextBox ID="txtCNH" runat="server" CssClass="form-control" MaxLength="11"></asp:TextBox>
